...
- Avoid importing python modules inside functions and methods. Instead import at module 
  level unless it causes circular depdencies. Optional imports for typing are allowed
  at module level.
...
- Place tests in a file like `tests/test_somename.py` in the `tests/`
